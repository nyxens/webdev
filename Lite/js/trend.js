...
//not neccecary but added by chatgpt suggestion
    ...
    btn.addEventListener("click",async(e) =>{
      ...
      if(!audio){
        ...
        if(cached[songId]){
          ...
          cached[songId].image = cached[songId].image || details.artworkUrl60 || "";
